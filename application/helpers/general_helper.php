...
{
    $CI = &get_instance();
    if ($CI->session->userdata('loggedin_role_id') == 9) { // Parent
        return true;
    }
    return false;
}

// is student logged in @return boolean
