...
<script>
// Bridge for old teacher validation expecting 'present_address'.
// On submit, copy Home Address into hidden present+permanent so validation passes without controller changes.
(function(){
  var form = document.currentScript.closest('form') || document.querySelector('form');
  if (!form) return;
  form.addEventListener('submit', function(){
    var home = (form.querySelector('[name="home_address"]')||{}).value || '';
    ['present_address','permanent_address'].forEach(function(name){
      var inp = form.querySelector('input[name="'+name+'"], textarea[name="'+name+'"]');
      if (!inp) {
