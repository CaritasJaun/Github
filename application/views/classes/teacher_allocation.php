...
<?php if (get_permission('assign_class_teacher', 'is_add')): ?>
    ...
    <?php
        ...
        // keep id="staff_id" so getStaffListRole() still targets it
        echo form_dropdown("staff_ids[]", $arrayTeacher, set_value('staff_ids'), "class='form-control' id='staff_id' multiple
