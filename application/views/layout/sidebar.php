<?php
$CI = &get_instance();
$main_menu = $CI->router->fetch_class();
$sub_page = $CI->router->fetch_class() . '/' . $CI->router->fetch_method();
$school_id = $CI->input->get('school_id');
?>
        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    <!-- Dashboard -->
                    <?php if (in_array(get_loggedin_role_id(), [1, 2, 3, 6])): ?>
...
if ($user_id > 0) {
    ...
    $unread_count = (int) $CI->notification_model->count_unread($user_id);
}
?>
<li class="<?php if ($main_menu == 'notification') echo 'nav-active'; ?>">
    <a href="<?= base_url('notification') ?>">
        <i class="fas fa-bell"></i>
        <span><?= translate('notifications') ?></span>
        <?php if ($unread_count > 0): ?>
            <span class="badge badge-danger pull-right"><?= $unread_count ?></span>
        <?php endif; ?>
    </a>
</li>

<!-- Branches (All + Individual) -->
                    <?php if (is_superadmin_loggedin()): ?>
                        <li class="nav-parent <?php if ($main_menu == 'dashboard') echo 'nav-active nav-expanded'; ?>">
                            <a><i class="icons icon-directions"></i><span><?= translate('branches') ?></span></a>
                            <ul class="nav nav-children">
                                <li class="<?php if ($main_menu == 'dashboard' && empty($school_id)) echo 'nav-active'; ?>">
                                    <a href="<?= base_url('dashboard') ?>">
                                        <i class="fas fa-caret-right"></i> <?= translate('all_branches') ?>
                                    </a>
                                </li>
                                <?php
                                ...
                                foreach ($branches as $row): ?>
                                    <li class="<?php if ($school_id == $row->id) echo 'nav-active'; ?>">
                                        <a href="<?= base_url('dashboard?school_id=' . $row->id) ?>">
                                            <i class="fas fa-caret-right"></i> <?= html_escape($row->name) ?>
                                        </a>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                    ...
                    <!-- PACE Management -->
<?php $ROLE = (int) get_loggedin_role_id(); ?>
<?php if (in_array($ROLE, [1,2,3,4,6,8])): // menu visible to these roles ?>
<li class="nav-parent <?php if ($main_menu == 'pace' || $main_menu == 'subjectpace') echo 'nav-expanded nav-active'; ?>">
    <a><i class="fas fa-book"></i><span>PACE Management</span></a>
    <ul class="nav nav-children">

        <!-- Assign Subjects (Admin + Teacher) -->
        <?php if (in_array($ROLE, [1,2,3], true)): ?>
        <li class="<?php if (in_array($sub_page, ['teacher/assign_subjects','employee/assign_subjects','pace/assign_subjects'])) echo 'nav-active'; ?>">
            <a href="<?= base_url('pace/assign_subjects'); ?>">
                <i class="fas fa-caret-right"></i> Assign Subjects
            </a>
        </li>
        <?php endif; ?>

        <!-- Order PACEs (ALLOW Teacher + Admin/SuperAdmin/Finance/Reception) -->
        <?php if (in_array($ROLE, [1,2,3,4,8])): ?>
        <li class="<?php if ($sub_page == 'pace/order') echo 'nav-active'; ?>">
            <a href="<?= base_url('pace/order'); ?>">
                <i class="fas fa-caret-right"></i> Order PACEs
            </a>
        </li>
        <?php endif; ?>

        <!-- Check Batches (Admin, SuperAdmin, Finance, Reception) -->
        <?php if (in_array($ROLE, [1,2,4,8])): ?>
        <li class="<?php if ($sub_page == 'pace/orders_batches') echo 'nav-active'; ?>">
            <a href="<?php echo base_url('pace/orders_batches_pre'); ?>">
                <i class="fas fa-caret-right"></i> Check Orders
            </a>
        </li>
        <?php endif; ?>
        
        <!-- Order Batches (Admin, SuperAdmin, Finance, Reception) -->
        <?php if (in_array($ROLE, [1,2,4,8])): ?>
        <li class="<?php if ($sub_page == 'pace/orders_batches') echo 'nav-active'; ?>">
            <a href="<?php echo base_url('pace/orders_batches'); ?>">
                <i class="fas fa-caret-right"></i> Ordered Batches
            </a>
        </li>
        <?php endif; ?>

        <!-- Invoices (Admin, SuperAdmin, Finance, Reception) -->
        <?php if (in_array($ROLE, [1,2,4,8])): ?>
        <li class="<?php if (in_array($sub_page, ['pace/invoices','pace/invoice_view'])) echo 'nav-active'; ?>">
            <a href="<?= base_url('pace/invoices'); ?>">
                <i class="fas fa-caret-right"></i> Invoices
            </a>
        </li>
        <?php endif; ?>

        <!-- Assign PACEs (Admin + Teacher) -->
        <?php if (in_array($ROLE, [1,2,3], true)): ?>
        <li class="<?php if ($sub_page == 'pace/assign') echo 'nav-active'; ?>">
            <a href="<?= base_url('pace/assign'); ?>">
                <i class="fas fa-caret-right"></i> Assign PACEs
            </a>
        </li>
        <?php endif; ?>

        <?php if (in_array($ROLE, [1,2,4,6,8])): ?>
        <li class="<?php if ($sub_page == 'subjectpace/library_list') echo 'nav-active'; ?>">
            <a href="<?= base_url('subjectpace/library_list'); ?>">
                <i class="fas fa-caret-right"></i> PACE Library
            </a>
        </li>
        <?php endif; ?>
...
<!-- Learning Centre -->
<li class="nav-parent <?php if (in_array($main_menu, ['learningcentre','spc','monitor_goal_check','weekly_traits','report'])) echo 'nav-expanded nav-active'; ?>">

    <a><i class="fas fa-clipboard-check"></i><span><?= translate('learning_centre') ?></span></a>
    <ul class="nav nav-children">

        <li class="<?php if ($sub_page == 'spc/index' || $main_menu == 'spc') echo 'nav-active'; ?>">
    <a href="<?= site_url('spc'); ?>">
        <i class="fas fa-chart-line"></i> <?= translate('supervisor_progress_card') ?>
    </a>
</li>

<li class="<?php if ($main_menu == 'monitor_goal_check') echo 'nav-active'; ?>">
    <a href="<?= site_url('monitor_goal_check'); ?>">
                <i class="fas fa-clipboard-list"></i> <?= translate('monitor_goal_check') ?>
            </a>
        </li>

        <!-- Weekly Traits -->
        <li class="<?php if ($main_menu == 'weekly_traits') echo 'nav-active'; ?>">
    <a href="<?= site_url('weekly_traits'); ?>">
                <i class="fas fa-check-square"></i> Weekly Traits
            </a>
        </li>

        <?php
        // Show Progress Report for roles 1,2,3,4,8 OR anyone with the permission flag
        $ROLE = (int) get_loggedin_role_id();
        if (get_permission('progress_reports', 'is_view') || in_array($ROLE, [1,2,3,4,8], true)) { ?>
            <li class="<?php if ($sub_page == 'report/progress_report') echo 'nav-active'; ?>">
                <a href="<?= base_url('report/progress_report'); ?>">
                    <i class="fas fa-file-alt"></i> <?= translate('progress') . ' ' . translate('report') ?>
                </a>
            </li>
        <?php } ?>
                    ...
                    <!-- Academic -->
<?php if (!in_array(get_loggedin_role_id(), [2, 3, 6,])): ?>
    <?php if (
        ...
        get_permission('student_promotion', 'is_view') ||
        get_loggedin_role_id() == 6 // for Set Term Dates
    ): ?>
        <li class="nav-parent <?php if (in_array($main_menu, ['classes', 'sections', 'timetable', 'subject', 'transfer'])) echo 'nav-expanded nav-active'; ?>">
            <a>
                <i class="icons icon-home" aria-hidden="true"></i>
                <span><?= translate('academic') ?></span>
            </a>
            <ul class="nav nav-children">
                ...
                <?php if (
                    ...
                    <li class="nav-parent <?php if (in_array($main_menu, ['classes', 'sections', 'class_teacher_allocation'])) echo 'nav-expanded nav-active'; ?>">
                        <a>
                        ...
                        <ul class="nav nav-children">
                            <?php if (get_permission('classes', 'is_view') || get_permission('section', 'is_view')): ?>
                                <li class="<?php if (in_array($sub_page, ['classes/index', 'classes/edit', 'sections/index', 'sections/edit'])) echo 'nav-active'; ?>">
                ...
                <?php if (
                    ...
                    <li class="nav-parent <?php if ($main_menu == 'subject') echo 'nav-expanded'; ?>">
                        <a><i class="fas fa-book-reader"></i><?= translate('subject') ?></a>
                        <ul class="nav nav-children">
                            <?php if (get_permission('subject', 'is_view')): ?>
                                <li class="<?php if (in_array($sub_page, ['subject/index', 'subject/edit'])) echo 'nav-active'; ?>">
                ...
                <?php if (in_array(get_loggedin_role_id(), [1, 6])): ?>
                    <li class="<?php if ($sub_page == 'monitor_goal_check/set_term_dates') echo 'nav-active'; ?>">
                        <a href="<?= base_url('monitor_goal_check/set_term_dates') ?>">
                            <i class="fas fa-calendar-alt"></i>
                            <span>Set Term Dates</span>
                        </a>
                    </li>
                <?php endif; ?>
...
?>
    ...
    <?php if (!in_array(get_loggedin_role_id(), [2, 3])): ?>
        <!-- admission -->
        <li class="nav-parent <?php if ($main_menu == 'admission') echo 'nav-expanded nav-active'; ?>">
            ...
            <ul class="nav nav-children">
                ...
                <?php if (moduleIsEnabled('multi_class') && get_permission('multi_class', 'is_add')): ?>
...
?>
    <li class="nav-parent <?php if ($main_menu == 'certificate') echo 'nav-expanded nav-active'; ?>">
        <a>
            <i class="icons icon-social-spotify"></i>
            <span><?= translate('certificate') ?></span>
        </a>
        <ul class="nav nav-children">

            <?php if ($role_id == 3): // Teacher ?>
                ...
                <li class="<?php if ($sub_page == 'certificate/generate_student') echo 'nav-active'; ?>">
                    <a href="<?= base_url('certificate/generate_student'); ?>">
                        <span><i class="fas fa-caret-right"></i><?= translate('generate_certificate') ?></span>
                    </a>
                </li>
                <?php endif; ?>

            <?php elseif ($role_id == 6): // Parent ?>
                <li>
                    <a href="#">
                        <span><i class="fas fa-caret-right"></i><?= translate('view_certificate') ?> (coming soon)</span>
                    </a>
                </li>

            <?php else: // Admin or Superadmin ?>
                <?php if (get_permission('certificate_templete', 'is_view')): ?>
                    <li class="<?php if ($sub_page == 'certificate/index' || $sub_page == 'certificate/edit') echo 'nav-active'; ?>">
                        <a href="<?= base_url('certificate'); ?>">
                            <span><i class="fas fa-caret-right"></i><?= translate('certificate') . " " . translate('templete') ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                <?php if (get_permission('generate_student_certificate', 'is_view')): ?>
                    <li class="<?php if ($sub_page == 'certificate/generate_student') echo 'nav-active'; ?>">
                        <a href="<?= base_url('certificate/generate_student'); ?>">
                            <span><i class="fas fa-caret-right"></i><?= translate('generate') . " " . translate('student') ?></span>
                        </a>
                    </li>
                <?php endif; ?>
                <?php if (get_permission('generate_employee_certificate', 'is_view')): ?>
                    <li class="<?php if ($sub_page == 'certificate/generate_employee') echo 'nav-active'; ?>">
                        <a href="<?= base_url('certificate/generate_employee'); ?>">
                            <span><i class="fas fa-caret-right"></i><?= translate('generate') . " " . translate('employee') ?></span>
                        </a>
                    </li>
                <?php endif; ?>
            <?php endif; ?>
...
?>
                    ...
                    <?php }} ?>
                    <?php
		if (get_loggedin_designation() != 'principal') {
